...
유아·아동 의류를 **옷장**을 통해 한눈에 관리하고, 가상 피팅을 통해 아이에게 어울리는 스타일을 직관적으로 확인할 수 있는 모바일 애플리케이션입니다.  
...
| 📤 AI 자동 분석 | 옷 이미지 업로드 시 AI가 자동으로 카테고리 분류 |
| 🔍 옷 검색 기능 | 이름 및 태그 기반 실시간 검색 |
| ➕ 옷 추가/삭제/수정 | Firebase Realtime Database 기반 실시간 동기화 |
