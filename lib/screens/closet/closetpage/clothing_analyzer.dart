        ...
        "contents": [
          {
            "parts": [
              {
                "text": "이 아기 옷의 종류와 색상을 분석해주세요. 종류는 '상의', '하의', '신발', '한벌옷' 중 하나로, 색상은 '흰색', '검정', '빨강', '주황', '노랑', '초록', '파랑', '남색', '보라', 회색', '분홍', '갈색' 중 하나로 알려주세요. 옷의 바탕이 되는 색으로 색상을 알려주세요. 굳이 정확한 색깔을 말해줄 필요는 없습니다. 이 옷을 입"
              },
              {
                "inline_data": {
